...
void setheader(blake2b_state *ctx, const char *header, const u32 headerlen, const char *nonce, const u32 noncelen) {
...
int verify(u32 indices[PROOFSIZE], const char *header, const u32 headerlen, const char *nonce, const u32 noncelen) {
  if (duped(indices))
